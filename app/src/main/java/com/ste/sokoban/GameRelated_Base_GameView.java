...
public class GameRelated_Base_GameView extends View {
    ...
    // Class init
    private GameRelated_Func_NewGame newgame = null;

    public GameRelated_Base_GameView(Context context, AttributeSet attrs) {
        super(context, attrs);

        newgame = (GameRelated_Func_NewGame) context;
    ...
    public int[][] getMap(int grade) {
        return GameRelated_Base_Maplist.getMap(grade);
    }
    ...
    private void getMapDetail() {
        ...
        tem = GameRelated_Base_Maplist.getMap(gate);
    }
    ...
    public void initPic() {
        ...
        loadPic(MAN, res.getDrawable(R.drawable.game_man));
    }
    ...
    public void nextGate() {
        if (gate < GameRelated_Base_Maplist.getCount() - 1) {
            gate++;
        } else {
            Toast.makeText(
                    this.getContext(),
